...
# Some values are updated for HH_run18F_434_mod2h
my %hvap_sim_ref = (
	'ethane' => 3.367917,
	'propane' => 4.422689,
	'butane' => 5.226038,
	'isobutane' => 4.996671,
	'cyclohexane' => 7.735395,
	'benzene' => 7.709,
	'toluene' => 9.546,
	'methanol' => 8.240,
	'ethanol' => 9.044,
...
## UPDATE!
my %hvap_static_ref = (
	'ethane' => 3.49212995342085,
	'propane' => 4.67062592034003,
	'butane' => 5.50436683860033,
	'isobutane' => 5.32251404083128,
	'cyclohexane' => 8.38813711481279,
...
# updated with results from HH_run18F_434_mod2h
my %dens_sim_ref = (
	'ethane' => 0.521920,
	'propane' => 0.562362,
	'butane' => 0.572317,
	'isobutane' => 0.550547,
	'cyclohexane' => 0.754316,
	'benzene' => 0.921,
	'toluene' => 0.922,
	'methanol' => 0.717,
	'ethanol' => 0.756,
...
my %dens_static_ref = (
	'ethane' => 0.523502293577982,
	'propane' => 0.574541371158393,
	'butane' => 0.585262086513994,
	'isobutane' => 0.561545,
	'cyclohexane' => 0.755968674698795,
...
foreach my $scfile (@ARGV) {
	...
	# Get the basename of the file before the first period. Assumes that
	# the files are named: '{tag}.xxxxxxx`
	$tag =~ s/.*\///g;
	...
	my ($scorecol,$volcol,$denscol,$corrcol,$intraAcol,$intraRcol,$cbcol) = (-1,-1,-1,-1,-1,-1,-1);
	...
	while (my $line=<SIL>) {
		...
		if ($line =~ /description/) {
			foreach my $i (0..$#fields) {
				...
				if ($fields[$i] eq "cart_bonded") { $cbcol=$i; }
			...
			my $score_i = ($fields[$scorecol] + $fields[$corrcol] - $fields[$intraAcol] - $fields[$intraRcol] - $fields[$cbcol])*0.5;
