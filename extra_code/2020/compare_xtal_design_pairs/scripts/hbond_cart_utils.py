...
pyrosetta.init('@/home/haddox/2020/compare_xtal_design_pairs/scripts/weights_and_flags/HH_run19A_flags_266 -mute all -mute core -mute protocols -detect_disulf False -read_only_ATOM_entries -crystal_refine')

# Set up a score function in `PyRosetta`
sf = pyrosetta.create_score_function('/home/haddox/2020/compare_xtal_design_pairs/scripts/weights_and_flags/HH_run19A_weights_266_cart.wts')
