...
def compute_hbond_energies(
    ...
    for hb in hbset.hbonds():
        ...
        acc_pdb_res_n = pose.pdb_info().number(acc_res_n)
        acc_atom_n = hb.acc_atm()
        acc_res = pose.residue(acc_res_n)
        acc_res_name = acc_res.name3()
        acc_atom_is_bb = acc_res.atom_is_backbone(acc_atom_n)
        ...
        hbond_dict['acc_pdb_res_n'].append(acc_pdb_res_n)
        hbond_dict['acc_atom_n'].append(acc_atom_n)
        hbond_dict['acc_res_name'].append(acc_res_name)
        hbond_dict['acc_atom_is_bb'].append(acc_atom_is_bb)
        ...
        don_pdb_res_n = pose.pdb_info().number(don_res_n)
        don_atom_n = hb.don_hatm()
        don_res = pose.residue(don_res_n)
        don_res_name = don_res.name3()
        don_atom_is_bb = don_res.atom_is_backbone(don_atom_n)
        ...
        hbond_dict['don_pdb_res_n'].append(don_pdb_res_n)
        hbond_dict['don_atom_n'].append(don_atom_n)
        hbond_dict['don_res_name'].append(don_res_name)
        hbond_dict['don_atom_is_bb'].append(don_atom_is_bb)
