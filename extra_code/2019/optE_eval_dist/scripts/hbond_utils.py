...
pyrosetta.init('-beta_nov16 -corrections:beta_nov16 -mute all -mute core -mute protocols -read_only_ATOM_entries')
...
def compute_hbond_energies(
    ...
    exclude_bb=False, exclude_bsc=False, exclude_scb=False, exclude_sc=False
):
